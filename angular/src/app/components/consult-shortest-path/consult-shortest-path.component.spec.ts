...
import {ConsultShortestPathComponent} from './consult-shortest-path.component';
...
describe('ConsultShortestPathComponent', () => {
  let component: ConsultShortestPathComponent;
  let fixture: ComponentFixture<ConsultShortestPathComponent>;
  ...
  beforeEach(async () => {
    ...
    fakePathService = jasmine.createSpyObj<ConsultPathService>('PathService', {
      consultShortestPath: of(pathMock),
    });
    await TestBed.configureTestingModule({
      declarations: [ConsultShortestPathComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConsultShortestPathComponent);
  ...
  it('should onsult shortest path', () => {
    window.localStorage.setItem('id', userMock.id);
    component.consultShortestPath('userSEIS');
    // @ts-ignore
